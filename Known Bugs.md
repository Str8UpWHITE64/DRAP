...
Do you also have Maintenance Tunnel Key? You need both to enter via the Maintenance Tunnel Access doors.
...
It's part of the AP jank and doesn't affect Logic or forward progression. When you start your next main Scoop, the Security Room state will change to reflect the current Scoop.

## A Bunch Of Different Cutscenes Just Played In The Security Room 

You completed multiple Scoops which take place in the Security Room. Congrats, you just chained forward progress!

## I Completed My Last Scoop In Security Room But "Memories" Isn't Triggering

Leave the Security Room, enter Paradise Plaza, then return to the Security Room via the Warehouse and Rooftops.
